...
if ($db->num_rows($sql_get_cate_post_1)) {
    if ($data_post['cate_1_id'] == '0') {
        echo '<option value="">Vui lòng chọn danh mục</option>';
    }
    ...
    echo '<option value="">Chưa có danh mục lớn nào</option>';
}
...
if ($db->num_rows($sql_get_cate_post_2)) {
    ...
    echo '<option value="">Chưa có danh mục vừa nào</option>';
}
...
if ($db->num_rows($sql_get_cate_post_3)) {
    ...
    echo '<option value="">Chưa có danh mục nhỏ nào</option>';
}
        ...
        <p>
            <form method="POST" id="formSearchPost" onsubmit="return false;">
                <div class="input-group">         
                    <input type="text" class="form-control" id="kw_search_post" placeholder="Mời nhập nội dung ...">
        ...
        <div class="table-responsive" id="list_post">
            <table class="table table-striped list">
                <tr>
                    ...
                    <td><strong>Danh mục tin tức</strong></td>
